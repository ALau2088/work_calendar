...
db.run(
  'CREATE TABLE IF NOT EXISTS users (id INTEGER NOT NULL PRIMARY KEY, first_name TEXT NOT NULL, last_name TEXT NOT NULL, email TEXT NOT NULL, workday_start_time TEXT NOT NULL, workday_end_time TEXT NOT NULL)',
  err => {
    if (err) {
      console.log(err.message);
    } else {
